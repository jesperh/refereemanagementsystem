...
module tuho {
    ...
    export class UserService {
        ...
        isUserInterestedThisYear(): any {
            ...
            return this.identity.interested;
        }
        ...
        willRefereeThisYear() {
            ...
            return this.$http.put("/api/user/interested/" + this.identity.id).then((data) => {
                this.identity.interested = true;
            });
        }
    }
